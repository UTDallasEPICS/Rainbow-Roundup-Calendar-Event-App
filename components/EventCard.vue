<template>
  <NuxtLink :to="`/event/${id}`">
    <div class="flex space-x-4 overflow-x-auto py-4">
      <div
        class="w-60 h-44 relative bg-white rounded-[20px] shadow-[0px_4px_4px_0px_rgba(80,85,136,0.25)] overflow-hidden p-4 flex flex-col justify-between"
      >
        <!-- 1) Amber bar + date + save button -->
        <div
          class="w-56 h-16 bg-amber-300 rounded-[10px] absolute top-[10px] left-1/2 -translate-x-1/2"
        >
          <!-- date square -->
          <div
