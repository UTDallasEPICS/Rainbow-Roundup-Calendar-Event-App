  ...
  <div class="p-6">
    ...
    <div class="flex flex-col gap-2">
      ...
      <div class="flex flex-col gap-1.5">
        <h1 class="text-2xl text-colour_charcoal font-bold">Rainbow Round Up</h1>
        <p class="text-md">
        ...
        <div class="flex flex-col gap-2">
          <label for="donation" class="text-lg font-semibold text-colour_charcoal">
        ...
        <form v-if="stripeLoaded" @submit.prevent="handleSubmit" class="block">
          ...
          <button
            ...
            type="submit"
            class="bg-colour_lavenderPurple text-white px-4 py-1.5 rounded-xl text-center whitespace-nowrap block w-full lg:min-w-[200px] lg:max-w-[300px] disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Submit
          </button>
