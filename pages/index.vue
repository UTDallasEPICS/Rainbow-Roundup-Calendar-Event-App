        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
          ...
          <div class="bg-gray-50 rounded-lg p-6 border">
            ...
            <div v-if="selectedDate">
              <div v-if="getEventsForDate(selectedDate).length > 0" class="space-y-3">
                <div 
                ...
                >
                  ...
                  <div class="text-gray-600 text-sm">{{ event.time }}</div>
                  <div class="text-gray-600 text-sm">Lat: {{ event.lat }} | Lng: {{ event.lng }}</div>
                </div>
              </div>
...
// keep in mind that lat long is no longer used for the moment
const events = ref([
        {
