<template>
  ...
  <div class="flex flex-col items-center">
    <h1 class="text-3xl font-bold text-colour_navy mt-6">
    ...
    <button
      class="mb-6 px-4 py-2 bg-colour_red text-white rounded-xl hover:bg-red-600 transition"
    ...
    <div v-if="editMode" class="mt-10 max-w-xl">
      <div class="bg-red-50 p-4 rounded-xl mb-4 border border-red-200">
        ...
        <button
          class="bg-colour_red hover:bg-red-600 text-white font-medium py-2 px-4 rounded-xl"
          @click="deleteAccount"
        >
          Delete
        </button>
    ...
    <div class="flex flex-col items-center">
      <br />
      <button
        class="w-[264px] border-none text-white text-lg text-center cursor-pointer mt-3 py-4 rounded-xl bg-colour_red hover:bg-red-600"
        @click="() => logout()"
      >
        Log Out
      </button>
