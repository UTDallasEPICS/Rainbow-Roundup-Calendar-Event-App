<template>
    ...
    <div class="flex flex-col items-center">
        <br>
        <button class="w-[264px] border-none text-white text-lg text-center cursor-pointer mt-3 py-4 rounded-xl bg-red-500 hover:bg-red-600" @click="() => signOut({ callbackUrl: '/login' })">Log Out</button>
    </div>
</div>
