...
INSERT INTO "new_PendingUser" ("email", "expires", "firstname", "id", "lastname", "phoneNum", "profilePic", "token") SELECT "email", "expires", "firstname", "id", "lastname", "phoneNum", "profilePic", "token" FROM "PendingUser";
